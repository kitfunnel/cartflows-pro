				...
				<div class="woocommerce-billing-fields-custom">
					...
					if ( ! is_user_logged_in() ) {
						...
						if ( 'yes' === get_option( 'woocommerce_enable_checkout_login_reminder' ) ) {
							...
							<?php
									echo "<input type='button' name='wcf-customer-login-btn' class='button wcf-customer-login-section__login-button' id='wcf-customer-login-section__login-button' value='" . esc_html( __( 'Login', 'cartflows-pro' ) ) . "'>";
