...
class Cartflows_Pro_Checkout_Rules {
	...
	public function conditional_redirection_after_checkout( $next_step_id, $order, $checkout_id ) {
		...
		if ( wcf()->utils->check_is_offer_page( self::$dynamic_step_id ) ) {
			self::$dynamic_step_id = Cartflows_Pro_Base_Offer_Markup::get_instance()->maybe_skip_offer( self::$dynamic_step_id, $order );
		}
